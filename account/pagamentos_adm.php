<?php
   ...
   $form = new Form;
    ...
    $consultaPagamentos = $db->query("SELECT * FROM paymets WHERE id_user <> '' ORDER BY id DESC ");
...
<div class="padding" style="margin-top: 10px;"> 
    ...
    <div class="box-header">
       <h7> <i class="material-icons md-24" style="font-size:22px;"></i> PAGAMENTOS</h3> 
    </div>
    <div class="table-responsive">
      <table ui-jp="dataTable" class="table table-striped b-t b-b" >
        <thead>
          <tr>  
              <th  style="5%"><font color="#981d1d">ID MODELO</font></th> 
                 <th  style="15%"><font color="#981d1d">DATA</font></th>
                 <th  style="15%"><font color="#981d1d">PLANO</font></th> 
                 <th  style="30%"><font color="#981d1d">VALOR</font></th> 
                  <th  style="30%"><font color="#981d1d">STATUS</font></th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($consultaPagamentos as $pagamento){ ?>
          <tr> 
                <td><?=$pagamento['id_user'];?></td>
