<?php
   include('inc/config.php'); 
    ...
    $consultaPesquisa = $pdo->query("SELECT * FROM users WHERE  firstname  LIKE '%$s%' OR lastname  LIKE '%$s%'  "); 
  error_reporting(0);
...
<html lang="pt-BR" id="html">
   ...
   <head>
      ...
      <title>Nosso Love: Pesquisar</title>
      <link rel="stylesheet" href="assets/content/cache/min/1/nl_937763584983622.css" media="all" data-minify="1" />
      <link rel="stylesheet" href="assets/css/style.css?v=<?=filesize('assets/css/style.css');?>" media="all" data-minify="1" />
...
display: none;
   ...
   <body data-rsssl=1 class="page-template page-template-categorias page-template-categorias-php page page-id-71701 _masterslider _ms_version_3.7.10 menu-position-top menu-style-v2 no-sidebar not-wrapped-widgets no-ads-on-smartphones no-ads-on-tablets with-infinite-scroll page-fixed-width with-transparent-menu">
      ...
      <article id="page-71701" class="pluto-page-box post-71701 page type-page status-publish hentry">
         ...
         <div class="tgrakz" style="margin:10px;">
            <h5>Resultados para: <?=strtoupper($s);?></h5>
         </div>
         ...
         <div id="primary-content" class="index-isotope hidden-on-load v3" data-layout-mode="masonry">
            ...
            <?php 
            foreach($consultaPesquisa as $pesquisa){ 
            if ($pesquisa['assinatura_ativa']=='SIM'){
                
            
         ?>    
              <tr onclick="window.location='perfil/<?=$pesquisa['username'];?>';" style="cursor:pointer; background-color:black;" >
                <td ><img src="account/files/profile/<?=$pesquisa['profile_photo'];?>" class="resizeImgSearch" style="border-radius: 5px;"></td>
                <td ><?=$pesquisa['firstname']." ".$pesquisa['lastname']?></td>
              </tr>
 ...
 <!-- pesquisar -->
  ...
  <div class="modal fade" id="modal-contato" role="dialog">
    ...
    <script src="assets/content/cache/min/1/nl_87892734872342.js" data-minify="1" defer></script>
   </body>
</html>